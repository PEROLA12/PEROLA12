...
client.on('message', async msg => {
    ...
    if (msg.body.match(/(menu|Menu|dia|tarde|noite|oi|Oi|Olá|olá|ola|Ola)/i) && msg.from.endsWith('@c.us')) {
        ...
        await client.sendMessage(msg.from,'Olá! '+ name.split(" ")[0] + 'Sou o assistente virtual da empresa tal. Como com milhares de usuarios 100% satisfeitos, tanto em atendimento, quanto qualidade. por um preço que cabe no seu bolso. Melhor custo-benefício. Teste antes de comprar. Teste por 7 DIAS Gratis. Assine agora. Planos partir de R$ 19,99 Qualidade e Preço justo.✅:\n\n1 - Como funciona\n2 - Valores dos planos\n3 - Benefícios\n4 - Como aderir\n5 - Outras perguntas'); //Primeira mensagem de texto
        await delay(3000); //delay de 3 segundos
        await chat.sendStateTyping(); // Simulando Digitação
